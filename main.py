...
API_ID = int(os.environ.get("API_ID", 26957728))
API_HASH = os.environ.get("API_HASH", "aed0db0d08b97b1fc7702f255ae4fcad")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7416233611:AAFjTkRr6-KbOrSL8WkjK4Yjooz5cnlptcg")
